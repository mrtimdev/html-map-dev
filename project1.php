                                    ...
                                    <div class="col-md-4 col-ms-4 col-xs-4">
                                        <div class="land_box">
                                            <div class="wrapper_content">
                                                <div class="wrapper wrapper_top y-axis">
                                                    <?= $top_body ?>
                                                </div>
                                                <div class="wrapper wrapper_middle x-axis">
                                                    <?= $middle_body ?>
                                                </div>
                                                <div class="wrapper wrapper_bottom y-axis">
                                                    <?= $bottom_body ?>
                                                </div>
                                            </div>  
                                        </div>
                                        ...
                                        <div class="land_box">
                                            <div class="wrapper_content">
                                                ...
                                                <div class="wrapper single_land">
                                                    <div class="box h-head-land-bottom "></div>
                                                </div>
                                            </div>  
                                        </div>
                                    </div>
